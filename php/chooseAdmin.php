...
<html lang="en">
    <head>
        ...
        <title>PMG - Panel de Administración</title>
        <link rel="stylesheet" href="../style/style-chooseAdmin.css">
        ...
        <div class="all">
            ...
            <div class="main">
                <div class="panelChoose">
                    <a href="./addSlide1.php" class="options slider">
                        <div class="img">
                            <?php
                                ...
                                if($resultado->num_rows > 0){
                                    ...
                                    echo '<img src="../images/img_sliders/'.$row['img_name'].'" alt="">';
                                }
                            ?>
                            <div class="txtOption">
                    ...
                    <a href="./upload-events.php" class="options slider">
                        <div class="img">
                            <img src="../images/imgNoticias.jpg" alt="">
                            <div class="txtOption">
                                <h1>NOTICIAS</h1>
                            </div>
                        </div>
                    ...
                    <a href="./ev_psic2.php" class="options slider">
                        <div class="img">
                            <img src="../images/Screenshot examen psicologico.webp" alt="">
                            <div class="txtOption">
                                <h1>Ex. Psicologico Individual</h1>
                            </div>
                        </div>
                    </a>
                </div>
