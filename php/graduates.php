...
<head>
    ...
    <title>PMG - Egresados</title>
    <link rel="stylesheet" href="../style/style-graduates.css">
            ...
            <div class="container-main">
                <div class="page">
                    ...
                    <div class="list-promotions">
                        <div class="empirex_XVLLL">
                            <div class="inf-promotions">
                                <a href="../promotions/empirex.html">
                                    <h1 class="name-promotion">EMPIREX</h1>
                                    <h2 class="age-promotions">MMXXIII</h2>
                                </a>
                            </div>
                            <a href="../promotions/empirex.html">
                                <div class="brand-promotion">
                                    <img src="../images/GRADUACIONES PMG/PROMO 2023/Banner Promoción.avif" alt="">
                                </div>
                            </a>
                            <div class="bgimage">
                                <img src="../images/GRADUACIONES PMG/PROMO 2023/Banner Promoción.avif" alt="">
                        ...
                        <div class="empirex_XVLLL">
                            <div class="inf-promotions">
                                <a href="../promotions/levels.html">
                                    <h1 class="name-promotion">LEVELS</h1>
                                    <h2 class="age-promotions">MMXXII</h2>
                                </a>
                            </div>
                            <a href="../promotions/levels.html">
                                <div class="brand-promotion">
                                    <img src="../images/Levels Logo.avif" alt="">
                                </div>
                            </a>
                            <div class="bgimage">
                                <img src="../images/Levels Logo.avif" alt="">
                        ...
                        <div class="empirex_XVLLL">
                            <div class="inf-promotions">
                                <a href="../promotions/strains.html">
                                    <h1 class="name-promotion">STRAINS</h1>
                                    <h2 class="age-promotions">MMXXI</h2>
                                </a>
                            </div>
                            <a href="../promotions/strains.html">
                                <div class="brand-promotion">
                                    <img src="../images/GRADUACIONES PMG/PROMO 2021/Logo Strains.png" alt="">
                                </div>
                            </a>
                            <div class="bgimage">
                                <img src="../images/GRADUACIONES PMG/PROMO 2021/Logo Strains.png" alt="">
