...
<head>
    ...
    <title>PMG - Prueba Psicológica</title>
...
<body>
    ...
    <main>
        <div class="alerts">
            ...
            //Nada interesante ni funcional. Pero esta ahi por si algun dia se utiliza
            ...
            //       if ( $_SESSION['user_email_address'] == "pmaximogomez2000@gmail.com" || $_SESSION['user_email_address'] == "alexandergomez41005@gmail.com" 
            ...
            //     //   || $_SESSION['user_email_address'] == "cselinenapol@gmail.com"  //Cselinet.sp
            //       || $_SESSION['user_email_address'] == "chelsynicolcastillosoto@gmail.com"  //Chelsy_Castillo22
            //     //   || $_SESSION['user_email_address'] == "ciarasoto30@icloud.com"  //ciarasoto858
            ...
            //     //   || $_SESSION['user_email_address'] == "amandapeguero2007@gmail.com"  //Lrelaa
            //       || $_SESSION['user_email_address'] == "eliancanario7@gmail.com"  //Elian09_5
            //     //   || $_SESSION['user_email_address'] == "elianmendez705@gmail.com"  //Elianmendez
            ...
            //     //   || $_SESSION['user_email_address'] == "raydelunpatrocinio@gmail.com"  //e.patrocinio
            ...
            //     //   || $_SESSION['user_email_address'] == "flor.moscat1105@gmail.com"  //Ella  
            ...
            //     //   || $_SESSION['user_email_address'] == "asenciojenifer75@gmail.com"  //JENIFERASENCIO
            ...
            //     //   || $_SESSION['user_email_address'] == "noemiparedesg@gmail.com"  //noemiparedesg@gmail.com
            //     //   || $_SESSION['user_email_address'] == "gonzlinver74@gmail.com"  //Linver13
            ...
            //       || $_SESSION['user_email_address'] == "zailar.soto@gmail.com"  //zailarr.soto28
            ...
            if (isset($_POST['submit'])) {
                ...
                $query2 = "SELECT * FROM test_psic WHERE email='$email'";
                ...
                if (mysqli_num_rows($validacion) > 0) {
                    ...
                    $query = "INSERT INTO test_psic(nombre_completo, apellido_completo, email, Comercio_Mercadeo1, Comercio_Mercadeo2, Contabilidad, Informatica, Industrias_Alimentarias, carrera)
